...
//   node src/commands/flint-bench.js --online [--max-spend 1] [--model claude-opus-4-8] [--report]
//
...
function readMicroLine(label) {
  try {
    const content = fs.readFileSync(path.join(ROOT, 'skills', 'flint', 'MICRO.md'), 'utf8');
