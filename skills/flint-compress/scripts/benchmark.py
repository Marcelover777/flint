...
def main():
    ...
    # Glob mode: repo_root/tests/flint-compress/
    # __file__ lives at <repo_root>/skills/flint-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → flint-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "flint-compress"
